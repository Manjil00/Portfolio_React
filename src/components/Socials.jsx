...
className='cursor-pointer h-[20px] rounded-full p-1 bg-white w-[20px] md:w-[30px] md:h-[30px] hover:w-[30px] hover:h-[30px] hover:md:w-[50px] hover:md:h-[50px]
