...
const Wordrotate = () => {
return (
    <div className='NAME_PLACE  font-boldfont text-left text-md md:text-2xl
    h-[120px] md:h-[200px] mt-10 md:mt-[80px] ml-[10px] md:ml-[100px] relative text-crimson overflow-hidden'>
        Hello,
    <br/>I am Manjil Maharjan &
    <br/>I am a
    <div className="inner-rotate  relative overflow-hidden h-[25px] md:h-[35px] w-full md:ml-[120px]">
